                ...
                <header className="d-flex container my-navbar flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4">
                    ...
                    <ul className="nav my-menu col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle px-2 me-5 link-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Services
                                <img src={ChevronDown} className="dropdown-icon-in-menu" />
                            </a>
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a className="dropdown-item" href="/courses">Online Course</a></li>
                                <li><a className="dropdown-item" href="/counseling">Counseling</a></li>
                            </ul>
                        </li>
                        <li><a href="/diary" className="nav-link px-2 me-5 link-dark">Diary</a></li>
                    </ul>
